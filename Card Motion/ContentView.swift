...
struct Card: View {
    ...
    var body: some View {
        ...
        .cornerRadius(15)
        .shadow(color: card.shadow.opacity(0.5), radius: 10, x: self.isCardTapped ? 0 : 8, y: 12)
...
let cardSection = [
    ...
    CardStructure(cardNumber: "6227 9067 1159 4103", cardProviderLogo: "visa-icon", cardCurrency: "AKZ", cardAmount: 1234564, linearColor1: Color(#colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1)), linearColor2: Color(#colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1)), shadow: Color(#colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1))),
    CardStructure(cardNumber: "6397 1190 3844 1503", cardProviderLogo: "mastercard-icon", cardCurrency: "AKZ", cardAmount: 46564, linearColor1: Color(#colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1)), linearColor2: Color(#colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)), shadow: Color(#colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1))),
    CardStructure(cardNumber: "5019 4973 5028 4325", cardProviderLogo: "visa-icon", cardCurrency: "AKZ", cardAmount: 87564, linearColor1: Color(#colorLiteral(red: 0.1019607857, green: 0.2784313858, blue: 0.400000006, alpha: 1)), linearColor2: Color(#colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)), shadow: Color(#colorLiteral(red: 0.1019607857, green: 0.2784313858, blue: 0.400000006, alpha: 1)))
]
